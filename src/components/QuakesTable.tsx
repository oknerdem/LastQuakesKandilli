...
function QuakesTable({ setSelected, item }: QuakesTableProps) {
  return (
    <div
      className="dark:bg-neutral-700/50 bg-neutral-200/50 rounded-md py-1.5 px-3 w-full flex justify-between items-center hover:opacity-60 active:opacity-80 duration-200 cursor-pointer"
